...
- 💡 **스마트 추천**: 6가지 정리 진입점 (오래된 스크린샷 / 용량 차지 / 동영상 / 라이브 사진 / 셀카 / 저해상도 이미지). 홈 가로 카드 + 「더보기」 시트에서 전체 목록 확인
...
- WeChat 후원 코드와 Alipay QR은 앱의 「설정 → 후원」에서 확인할 수 있습니다.

## 링크

- [공식 웹사이트](https://zanwingmak.github.io/PhotoCleaner/)
